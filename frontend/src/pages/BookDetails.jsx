        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="aspect-square bg-gray-100 rounded-xl overflow-hidden">
              <img
                src={images[currentImageIndex]?.image_url || "/placeholder.svg?height=400&width=400&text=Libro"}
            ...
            <div>
              ...
              <div className="flex items-center space-x-2 mb-4">
                <span className={`px-3 py-1 rounded-full text-sm font-medium ${
                  transactionType?.description === "Regalo" ? "bg-blue-100 text-blue-800" :
                  transactionType?.description === "Intercambio" ? "bg-purple-100 text-purple-800" :
                  transactionType?.description === "Venta" ? "bg-green-100 text-green-800" :
            ...
            {location && (
              <div className="bg-white p-4 rounded-lg border">
                ...
                <div className="flex items-center text-gray-600">
                  ...
                  <span>{location.comuna}, {location.region}</span>
                </div>
              </div>
            )}
