...
router.post(
  "/",
  /* authenticateToken, requireAdmin, validateCategoryData, */ createCategory
);

// Actualizar categoría
router.put(
  "/:id",
  /* authenticateToken, requireAdmin, validateCategoryData, */ updateCategory
);

// Eliminar categoría
router.delete(
  "/:id",
  /* authenticateToken, requireAdmin, validateCategoryDeletion, */ deleteCategory
);
